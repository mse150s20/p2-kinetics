...
# where A is uninfected, B is infected, C is recovered
        A,B,C = y
        return [-k1*A*B/(A+B+C), k1*A*B/(A+B+C)-k2*B, k2*B] #The equation for deaths will just be (k3*B) for the death count and (-k3*B) for the infected part. We just need the deathe count.
