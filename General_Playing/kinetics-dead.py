...
# where A is uninfected, B is infected, C is recovered, and D is dead
        healthy,infected,recovered,dead = y
        return [-rateInfect*healthy*infected/(healthy+infected+recovered+dead), rateInfect*healthy*infected/(healthy+infected+recovered+dead)-rateRecover*infected-rateDie*infected, rateRecover*infected, rateDie*infected]
