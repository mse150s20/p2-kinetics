...
# where A is uninfected, B is infected, C is recovered, and D is dead
        healthy,infected,recovered,D = y
        return [-rateInfect*healthy*infected/(healthy+infected+recovered+D), rateInfect*healthy*infected/(healthy+infected+recovered+D)-rateRecover*infected-rateDie*infected, rateRecover*infected, rateDie*infected]
